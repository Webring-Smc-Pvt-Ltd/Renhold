...
import {SHOPPINGDELIVERY} from '../../../../data';
  ...
  return (
    <>
      <LayoutWrapper>
        <Box>
          <Box
            bgImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/ServiceDetail/shopping.png')" // Replace 'path/to/your/image.jpg' with the actual path to your image file
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            ...
            >
              ...
              <Text
                ...
                color="#FFFFFF"
              >
                Taskers can deliver just about anything - from groceries to dry cleaning to furniture.
              </Text>
            </Box>
          </Box>
          <Box
          ...
          >
            <Flex gap="50px" flexDirection={{ base: 'column', lg: 'row' }}>
              <Box w={{ base: '100%', lg: '60%' }}>
                {SHOPPINGDELIVERY?.map((Service, index) => (
                  <Box
                    key={index}
                    p="30px"
