  ...
  return (
    <>
      <LayoutWrapper>
        <Box>
          <Box
            bgImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/ServiceDetail/ikea.png')" // Replace 'path/to/your/image.jpg' with the actual path to your image file
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            ...
            >
              ...
              <Text
                ...
                color="#FFFFFF"
              >
                Taskers are here to help make everyday life easier at home.
                Get help assembling and mounting new furniture, 
                removing old furniture, setting up smart home systems, and more.
              </Text>
            </Box>
          </Box>
          <Box
