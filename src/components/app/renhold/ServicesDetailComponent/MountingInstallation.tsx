...
import {MOUNTINGANDINSTALLATION} from '../../../../data';
const MountingInstallation = () => {
  ...
  return (
    <>
      <LayoutWrapper>
        <Box>
          <Box
            bgImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/ServiceDetail/Mounting.png')" // Replace 'path/to/your/image.jpg' with the actual path to your image file
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            <Flex gap="50px" flexDirection={{ base: 'column', lg: 'row' }}>
              <Box w={{ base: '100%', lg: '60%' }}>
                {MOUNTINGANDINSTALLATION?.map((Service, index) => (
                  <Box
                    key={index}
                    p="30px"
...
export default MountingInstallation;
