  ...
  return (
    <>
      <LayoutWrapper>
        <Box>
          <Box
            bgImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/ServiceDetail/contactless.jfif')" // Replace 'path/to/your/image.jpg' with the actual path to your image file
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            ...
            >
              ...
              <Text
                ...
                color="#FFFFFF"
              >
                Request no-contact help to get the assistance you need while maintaining social distancing.
                Just note in your booking details where to safely pick up or drop off items.
              </Text>
            </Box>
          </Box>
          <Box
          ...
          >
            <Flex gap="50px" flexDirection={{ base: 'column', lg: 'row' }}>
              <Box w={{ base: '100%', lg: '60%' }}>
                {CONTACTLESSSERVICES?.map((Service, index) => (
                  <Box
                    key={index}
                    p="30px"
...
export default ContactlessServices;
