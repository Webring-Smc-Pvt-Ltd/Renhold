  ...
  return (
    <>
      <LayoutWrapper>
        <Box>
          <Box
            bgImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/ServiceDetail/moving.jfif')" // Replace 'path/to/your/image.jpg' with the actual path to your image file
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            ...
            >
              ...
              <Text
                ...
                color="#FFFFFF"
              >
                From the heavy lifting to unpacking and organizing make your move with Renhold!
              </Text>
            </Box>
          </Box>
          <Box
