            ...
            >
              ...
              >
                ...
                <Text fontSize="md" mb={6} color="gray.600">
                  Learn why Vanessa, Shaneka, Eric, Zalika, Trevor, and Alana
                  became Taskers and how tasking has allowed them to earn money
                  while preserving their freedom over their time and hourly
                  earnings.
                </Text>
                <Button
                  bg="green.700"
