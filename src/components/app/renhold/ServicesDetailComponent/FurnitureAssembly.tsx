...
import {FURNITUREASEMBLY} from '../../../../data';
  ...
  return (
    <>
      <LayoutWrapper>
        <Box>
          <Box
            bgImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/ServiceDetail/Furniture.png')" // Replace 'path/to/your/image.jpg' with the actual path to your image file
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            ...
            >
              ...
              <Text
                ...
                color="#FFFFFF"
              >
                Have a new desk or bookcase to put together? Confused by the directions? 
                Taskers can assemble all of your furniture - quickly and efficiently. Book someone today!
              </Text>
            </Box>
          </Box>
          <Box
          ...
          >
            <Flex gap="50px" flexDirection={{ base: 'column', lg: 'row' }}>
              <Box w={{ base: '100%', lg: '60%' }}>
                {FURNITUREASEMBLY?.map((Service, index) => (
                  <Box
                    key={index}
                    p="30px"
